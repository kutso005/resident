  ...
  return (
    <div className="container">
      <div className="popular-block-back">
        {Array.isArray(residentList?.Rascule_rest) &&
          residentList?.Rascule_rest?.slice(0, 1).map((el) => (
            <div>
              <div className="d-flex justify-content-between align-items-center mb-2">
                <h1 className="title">Роскошный отдых</h1>
        ...
        <div className="row">
          <div className="col-md-6 col-12 banner-mobile">
            <div className="row" style={{ margin: "0 0 0 0" }}>
              {residentList?.Rascule_rest?.filter((el) => {
                return el.title
                  .toLowerCase()
